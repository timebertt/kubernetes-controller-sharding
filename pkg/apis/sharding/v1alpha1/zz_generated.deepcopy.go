...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterRingKind) DeepCopyInto(out *ClusterRingKind) {
	*out = *in
	out.ObjectKind = in.ObjectKind
	if in.ControlledKinds != nil {
		in, out := &in.ControlledKinds, &out.ControlledKinds
		*out = make([]ObjectKind, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterRingKind.
func (in *ClusterRingKind) DeepCopy() *ClusterRingKind {
	if in == nil {
		return nil
	}
	out := new(ClusterRingKind)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterRingSpec) DeepCopyInto(out *ClusterRingSpec) {
	*out = *in
	if in.Kinds != nil {
		...
		*out = make([]ClusterRingKind, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
